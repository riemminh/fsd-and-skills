...
priority: high
triggerKeywords: [order, status, payment, cancel, role, permission, admin, manager, viewer, money, total, tax]
---
...
Matrix, demo accounts, auth keys, cancel rules: `references/orders-rbac.md`
